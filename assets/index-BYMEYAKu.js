 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dl{constructor(e,n,s){this.path=e,this.affectedTree=n,this.revert=s,this.type=Ut.ACK_USER_WRITE,this.source=wg()}operationForChild(e){if(te(this.path)){if(this.affectedTree.value!=null)return x(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new de(e));return new dl(oe(),n,this.revert)}}else return x(ee(this.path)===e,"operationForChild called for unrelated child."),new dl(pe(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ws{constructor(e,n){this.source=e,this.path=n,this.type=Ut.LISTEN_COMPLETE}operationForChild(e){return te(this.path)?new ws(this.source,oe()):new ws(this.source,pe(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pr{constructor(e,n,s){this.source=e,this.path=n,this.snap=s,this.type=Ut.OVERWRITE}operationForChild(e){return te(this.path)?new pr(this.source,oe(),this.snap.getImmediateChild(e)):new pr(this.source,pe(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Es{constructor(e,n,s){this.source=e,this.path=n,this.children=s,this.type=Ut.MERGE}operationForChild(e){if(te(this.path)){const n=this.children.subtree(new de(e));return n.isEmpty()?null:n.value?new pr(this.source,oe(),n.value):new Es(this.source,oe(),n)}else return x(ee(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Es(this.source,pe(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Bu;const HS=()=>(Bu||(Bu=new ct(PE)),Bu);class _e{static fromObject(e){let n=new _e(null);return dt(e,(s,l)=>{n=n.set(new de(s),l)}),n}constructor(e,n=HS()){this.value=e,this.children=n}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,n){if(this.value!=null&&n(this.value))return{path:oe(),value:this.value};if(te(e))return null;{const s=ee(e),l=this.children.get(s);if(l!==null){const u=l.findRootMostMatchingPathAndValue(pe(e),n);return u!=null?{path:Le(new de(s),u.path),value:u.value}:null}else return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,()=>!0)}subtree(e){if(te(e))return this;{const n=ee(e),s=this.children.get(n);return s!==null?s.subtree(pe(e)):new _e(null)}}set(e,n){if(te(e))return new _e(n,this.children);{const s=ee(e),u=(this.children.get(s)||new _e(null)).set(pe(e),n),d=this.children.insert(s,u);return new _e(this.value,d)}}remove(e){if(te(e))return this.children.isEmpty()?new _e(null):new _e(null,this.children);{const n=ee(e),s=this.children.get(n);if(s){const l=s.remove(pe(e));let u;return l.isEmpty()?u=this.children.remove(n):u=this.children.insert(n,l),this.value===null&&u.isEmpty()?new _e(null):new _e(this.value,u)}else return this}}get(e){if(te(e))return this.value;{const n=ee(e),s=this.children.get(n);return s?s.get(pe(e)):null}}setTree(e,n){if(te(e))return n;{const s=ee(e),u=(this.children.get(s)||new _e(null)).setTree(pe(e),n);let d;return u.isEmpty()?d=this.children.remove(s):d=this.children.insert(s,u),new _e(this.value,d)}}fold(e){return this.fold_(oe(),e)}fold_(e,n){const s={};return this.children.inorderTraversal((l,u)=>{s[l]=u.fold_(Le(e,l),n)}),n(e,this.value,s)}findOnPath(e,n){return this.findOnPath_(e,oe(),n)}findOnPath_(e,n,s){const l=this.value?s(n,this.value):!1;if(l)return l;if(te(e))return null;{const u=ee(e),d=this.children.get(u);return d?d.findOnPath_(pe(e),Le(n,u),s):null}}foreachOnPath(e,n){return this.foreachOnPath_(e,oe(),n)}foreachOnPath_(e,n,s){if(te(e))return this;{this.value&&s(n,this.value);const l=ee(e),u=this.children.get(l);return u?u.foreachOnPath_(pe(e),Le(n,l),s):new _e(null)}}foreach(e){this.foreach_(oe(),e)}foreach_(e,n){this.children.inorderTraversal((s,l)=>{l.foreach_(Le(e,s),n)}),this.value&&n(e,this.value)}foreachChild(e){this.children.inorderTraversal((n,s)=>{s.value&&e(n,s.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zt{constructor(e){this.writeTree_=e}static empty(){return new zt(new _e(null))}}function ds(i,e,n){if(te(e))return new zt(new _e(n));{const s=i.writeTree_.findRootMostValueAndPath(e);if(s!=null){const l=s.path;let u=s.value;const d=ut(l,e);return u=u.updateChild(d,n),new zt(i.writeTree_.set(l,u))}else{const l=new _e(n),u=i.writeTree_.setTree(e,l);return new zt(u)}}}function Bp(i,e,n){let s=i;return dt(n,(l,u)=>{s=ds(s,Le(e,l),u)}),s}function Hp(i,e){if(te(e))return zt.empty();{const n=i.writeTree_.setTree(e,new _e(null));return new zt(n)}}function sc(i,e){return yr(i,e)!=null}function yr(i,e){const n=i.writeTree_.findRootMostValueAndPath(e);return n!=null?i.writeTree_.get(n.path).getChild(ut(n.path,e)):null}function $p(i){const e=[],n=i.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(Ie,(s,l)=>{e.push(new J(s,l))}):i.writeTree_.children.inorderTraversal((s,l)=>{l.value!=null&&e.push(new J(s,l.value))}),e}function Vn(i,e){if(te(e))return i;{const n=yr(i,e);return n!=null?new zt(new _e(n)):new zt(i.writeTree_.subtree(e))}}function oc(i){return i.writeTree_.isEmpty()}function oi(i,e){return Sg(oe(),i.writeTree_,e)}function Sg(i,e,n){if(e.value!=null)return n.updateChild(i,e.value);{let s=null;return e.children.inorderTraversal((l,u)=>{l===".priority"?(x(u.value!==null,"Priority writes must always be leaf nodes"),s=u.value):n=Sg(Le(i,l),u,n)}),!n.getChild(i).isEmpty()&&s!==null&&(n=n.updateChild(Le(i,".priority"),s)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const KC=/[\[\].#$\/\u0000-\u001F\u007F]/,qC=/[\[\].#$\u0000-\u001F\u007F]/,Hu=10*1024*1024,Wg=function(i){return typeof i=="string"&&i.length!==0&&!KC.test(i)},jg=function(i){return typeof i=="string"&&i.length!==0&&!qC.test(i)},QC=function(i){return i&&(i=i.replace(/^\/*\.info(\/|$)/,"/")),jg(i)},Vg=function(i,e,n){const s=n instanceof de?new dS(n,i):n;if(e===void 0)throw new Error(i+"contains undefined "+cr(s));if(typeof e=="function")throw new Error(i+"contains a function "+cr(s)+" with contents = "+e.toString());if(Vm(e))throw new Error(i+"contains "+e.toString()+" "+cr(s));if(typeof e=="string"&&e.length>Hu/3&&Il(e)>Hu)throw new Error(i+"contains a string greater than "+Hu+" utf8 bytes "+cr(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let l=!1,u=!1;if(dt(e,(d,h)=>{if(d===".value")l=!0;else if(d!==".priority"&&d!==".sv"&&(u=!0,!Wg(d)))throw new Error(i+" contains an invalid key ("+d+") "+cr(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);fS(s,d),Vg(i,h,s),hS(s)}),l&&u)throw new Error(i+' contains ".value" child '+cr(s)+" in addition to actual children.")}},Bg=function(i,e,n,s){if(!jg(n))throw new Error(Dm(i,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},YC=function(i,e,n,s){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Bg(i,e,n)},XC=function(i,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Wg(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!QC(n))throw new Error(Dm(i,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vl=new Ec("@firebase/auth");function bI(i,...e){vl.logLevel<=ce.WARN&&vl.warn(`Auth (${ci}): ${i}`,...e)}function Xo(i,...e){vl.logLevel<=ce.ERROR&&vl.error(`Auth (${ci}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
